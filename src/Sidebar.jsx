...
export default function Sidebar() {
  return (
    <div>
      <nav className="bg-[#0a0a0a8a] h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 tracking-wide overflow-auto">
        <div className="flex flex-wrap items-center gap-4 cursor-pointer">
          <div>
            <p className="text-lg">Al Caponents</p>
          </div>
        </div>
        ...
        <ul className="space-y-3">
          <li>
            <a
              href="/cards"
              className="text-white text-[15px] font-normal flex items-center rounded px-4 py-2 transition-all"
            >
              <svg
